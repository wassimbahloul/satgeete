...
var ɵisSupportedError = (module2) => `The APP_INITIALIZER that is "making" isSupported() sync for the sake of convenient DI has not resolved in this
context. Rather than injecting ${module2} in the constructor, first ensure that ${module2} is supported by calling
\`await isSupported()\`, then retrieve the instance from the injector manually \`injector.get(${module2})\`.`;
...
firebase/compat/app/dist/esm/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YCWE5NHP.js.map
